  ...
  return (
    <Tab.Navigator screenOptions={{ headerShown: false, tabBarShowLabel: false }}>
      <Tab.Screen name="HomeStack" component={HomeStackScreen}
        options={{
          tabBarIcon: ({ focused }) => (
            <HomeIcon name="home" size={26} color={focused ? 'black' : 'gray'} />
          ),
        }}
      />
      <Tab.Screen name="Oganization" component={OrgStackScreen}
        options={{
          tabBarIcon: ({ focused }) => (
            <OrgIcon name="organization" size={26} color={focused ? 'black' : 'gray'} />
          ),
        }}
      />
      <Tab.Screen name="Add" component={OrgRegistration}
        options={{
          tabBarIcon: ({ focused }) => (
            <OrgIcon name="diff-added" size={26} color={focused ? 'black' : 'gray'} />
          ),
        }}
      />
      <Tab.Screen name="History" component={Subscription}
        options={{
          tabBarIcon: ({ focused }) => (
            <HistoryIcon name="history" size={26} color={focused ? 'black' : 'gray'} />
          ),
        }}
      />
      <Tab.Screen name="Notification" component={Notifications}
        options={{
          tabBarIcon: ({ focused }) => (
            <HomeIcon name="notifications" size={26} color={focused ? 'black' : 'gray'} />
          ),
        }}
      />
    </Tab.Navigator>
